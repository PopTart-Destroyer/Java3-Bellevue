        ...
        buttonPrev.addActionListener(new java.awt.event.ActionListener()
          {
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt)
              {
                if (arrayPointer == 0)  //if pointer eq 0
                  {
                    arrayPointer = DataClassArray.length - 1;	//move pointer to last element in array
                  } else
                  {
        ...
        buttonNext.addActionListener(new java.awt.event.ActionListener()
          {
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt)
              {
                if (arrayPointer == DataClassArray.length - 1)	//if pointer eq length of array
                  {
                    arrayPointer = 0;	//set pointer to zerop
                  } else
                  {
        ...
        buttonReset.addActionListener(new java.awt.event.ActionListener()
          {
            ...
            public void actionPerformed(ActionEvent ae)
              {
                arrayPointer = 0;	// set default value of pointer to initial element
                setFields(arrayPointer);
              }
          });
      }
    ...
    public static void main(String args[])
      {
        ...
        a2.setFields(0);	// set default value for DataClassArray to zero when program starts.
        a2.setSize(400, 350);
        a2.setVisible(true);
      }
  }
